...
<html lang="en">
  <head>
    ...
    <title><?php echo $fetch_info['name'] ?> | Deluxe-Rooms</title>
  ...
  <body>
    ...
    <div class="wrapper">
        <div class="konten">
            <img src="../../../assets/img/b1.jpg" alt="deluxe-rooms">
            <div class="about-rooms">
                <h2>Deluxe Rooms</h2>
                <div class="deskripsi">
                    <h5>Deskripsi</h5>
                    <p>Kamar deluxe adalah salah satu pilihan paling populer bagi tamu yang menginap di hotel bintang 5 karena menawarkan kenyamanan dan fasilitas tanpa terlalu berlebihan atau mahal. Tempat ini memiliki setidaknya dua tempat tidur yang dapat menampung hingga empat orang sehingga sangat cocok untuk mereka yang bepergian dalam kelompok atau keluarga kecil. Ruang tamu juga disediakan yang mencakup meja dan kursi serta pembuat teh dan kopi dengan perlengkapan yang cukup. Minibar juga dapat disertakan. Kamar Deluxe mirip dengan kamar double tetapi lebih luas dan umumnya memiliki lebih banyak fasilitas dan furnitur berkualitas lebih tinggi.</p>
                    <div class="rate">
