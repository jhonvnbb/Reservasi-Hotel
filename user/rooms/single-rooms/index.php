...
<html lang="en">
  <head>
    ...
    <title><?php echo $fetch_info['name'] ?> | Single-Rooms</title>
  ...
  <body>
    ...
    <div class="wrapper">
        <div class="konten">
            <img src="../../../assets/img/b3.jpg" alt="suite-rooms">
            <div class="about-rooms">
                <h2>Single Rooms</h2>
                <div class="deskripsi">
                    <h5>Deskripsi</h5>
                    <p>Salah satu jenis kamar yang paling umum di hotel mana pun. Biasanya, ini berarti ruangan tersebut memiliki satu tempat tidur yang diperuntukkan bagi satu orang atau pasangan, namun tidak berarti ruangan tersebut kecil. Faktanya, beberapa hotel mungkin menawarkan kamar yang lebih besar dibandingkan hotel lainnya, bergantung pada ukuran hotel itu sendiri. Tamu yang bepergian sendiri atau untuk urusan bisnis biasanya menempati kamar single jika mereka memerlukan akomodasi jangka pendek dan tidak membutuhkan banyak ruang tambahan. Mereka biasanya sendirian di dalam kamar dan menggunakan ruang tersebut terutama untuk tujuan tidur dan bersiap-siap untuk pergi keluar.</p>
                    <div class="rate">
                ...
                <div class="harga">
                    <h3>Rp.1.000.000,00 <br> <span>/ Per Malam</span></h3>
                </div>
            </div>
        </div>
        <div class="book">
            <form action="" method="">
                ...
                <input type="text" name="kamar" id="kamar" value="Single-Rooms" disabled>
