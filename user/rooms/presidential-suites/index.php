...
<html lang="en">
  <head>
    ...
    <title><?php echo $fetch_info['name'] ?> | Presidential-Suites</title>
  ...
  <body>
    ...
    <div class="wrapper">
        <div class="konten">
            <img src="../../../assets/img/b2.webp" alt="suite-rooms">
            <div class="about-rooms">
                <h2>Presidential Suites</h2>
                <div class="deskripsi">
                    <h5>Deskripsi</h5>
                    <p>Kamar presidensial atau eksekutif menekankan kenyamanan dan kemewahan di atas segalanya dan sering kali merupakan kamar termahal di hotel bintang 5. Kamar memiliki lebih banyak ruang, dekorasi yang lebih bagus, serta fasilitas dan layanan yang lebih banyak dibandingkan suite biasa. Selain itu, ini mencakup fasilitas dan layanan tambahan yang memberikan pengalaman lebih baik dan nyaman, seperti meja kerja besar, bak mandi air panas, perapian, dapur persiapan, ruang kebugaran, kolam renang pribadi, dan layanan 24/7. Keamanan di dalam dan sekitar ruangan ini seringkali ditingkatkan karena tamu yang memesannya mungkin adalah tokoh masyarakat terkemuka.</p>
                    <div class="rate">
                ...
                <div class="fasilitas">
                  <h5>Fasilitas</h5>
                    <ul>
                        ...
                        <li>Fasilitas Ekslusif</li>
                        <li>Ruang Tamu</li>
                        <li>Best View</li>
                    </ul>
                </div>
                <div class="harga">
                    <h3>Rp.3.050.000,00 <br> <span>/ Per Malam</span></h3>
                </div>
            </div>
        </div>
        <div class="book">
            <form action="./" method="POST">
                ...
                <input type="text" name="kamar" id="kamar" value="Presidential-Suites" readonly>
