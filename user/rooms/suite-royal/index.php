...
<html lang="en">
  <head>
    ...
    <title><?php echo $fetch_info['name'] ?> | Suite-Royal</title>
  ...
  <body>
    ...
    <div class="wrapper">
        <div class="konten">
            <img src="../../../assets/img/b5.jpg" alt="suite-rooms">
            <div class="about-rooms">
                <h2>Suite Royal</h2>
                <div class="deskripsi">
                    <h5>Deskripsi</h5>
                    <p>Kamar Suite Royal adalah pilihan terbaik bagi tamu yang menginginkan kemewahan dan kenyamanan tertinggi selama menginap di hotel bintang 5. Suite ini dirancang untuk memberikan pengalaman menginap yang luar biasa dengan ruang yang luas dan fasilitas yang lengkap. Kamar Suite Royal memiliki setidaknya tiga kamar tidur yang dapat menampung hingga enam orang, menjadikannya pilihan ideal untuk mereka yang bepergian dalam kelompok besar atau keluarga. Setiap kamar tidur dilengkapi dengan tempat tidur king-size, linen mewah, dan jendela besar yang menawarkan pemandangan spektakuler.</p>
                    <div class="rate">
                ...
                <div class="fasilitas">
                  <h5>Fasilitas</h5>
                    <ul>
                        ...
                        <li>Balkon</li>
                        <li>Kamar Mandi Bathtub Jacuzzi</li>
                        <li>Minibar</li>
                        <li>Area Kerja</li>
                    </ul>
                </div>
                <div class="harga">
                    <h3>Rp.5.000.000,00 <br> <span>/ Per Malam</span></h3>
                </div>
            </div>
        </div>
        <div class="book">
            <form action="./" method="POST">
                ...
                <input type="text" name="kamar" id="kamar" value="Deluxe-Rooms" readonly>
