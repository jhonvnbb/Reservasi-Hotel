...
<body>
    <nav class="navbar">
        <div class="navbar-nav">
          ...
          <h2><span>AstonServe</span> Sign up</h2>
        </div>
    </nav>
            ...
            <div class="col-md-4 offset-md-4 form">
                <form action="./index.php" method="POST" autocomplete="">
                    ...
                    <div class="form-group mt-3">
                        <input class="form-control" type="text" name="name" placeholder="Nama" required value="<?php echo $name ?>">
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <div class="link login-link text-center mt-2">Punya akun? <a href="../login/" class="text-decoration-none">Masuk</a></div>
                </form>
            </div>
        </div>
    </section>
